...
<SOAtestProject xmlVersion="5" productVersion="9.4.2" servicePackVersion="2">
    ...
    <EnvironmentConfiguration className="webtool.environment.EnvironmentConfiguration" version="1">
      ...
      <Environment className="webtool.environment.Environment" version="1">
        ...
        <EnvironmentVariable className="webtool.environment.EnvironmentVariable" version="3">
          <maskValue>AgAAACCLb0CJy5huFVa0qyTZi5InifWcMLJFEXHY2qy+lHgFKQ==</maskValue>
          <value>AgAAAFAf29j8eUnZ0BwZPdpg4jwFoF+M0pW17tkehisMipEslSmScuYTEEsXdP7dbTKEAbb2MSO+Xtb4QLT30pvYpegGz+ejGeASZcci5CXvTZYHjg==</value>
          <name>ENDPOINT</name>
        </EnvironmentVariable>
        <EnvironmentVariable className="webtool.environment.EnvironmentVariable" version="3">
          <maskValue>AgAAACA4DLFVpSsXsS9b9+ec+O0w2kxXsQotSYPm0aB46nR/Wg==</maskValue>
          <value>AgAAAFCOi8szX+94ahtn/IiJWptzfhf1VYXvZly5rMEyeRrRbgAwkXVvburSxLbzBX6eZc4zTHtCW+zjcQqqbYD3DQxVEsXZMNtXk8QGnISCvX0XTQ==</value>
          <name>WSDL</name>
        </EnvironmentVariable>
      </Environment>
